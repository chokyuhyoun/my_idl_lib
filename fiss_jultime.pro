...
yr=strmid(f_fiss, position+5, 4)
mon=strmid(f_fiss, position+9, 2)
dat=strmid(f_fiss, position+11, 2)
hr=strmid(f_fiss, position+14, 2)
min=strmid(f_fiss, position+16, 2)
sec=strmid(f_fiss, position+18, 2)
