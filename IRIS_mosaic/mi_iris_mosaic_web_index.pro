...
;	html_leadin = '<p style="width:' + STRTRIM(tabwidth, 2) + 'px"> This is the web page for IRIS mosaics. FITS files can be accessed by clicking on the date links in the table below. Instructions for reading and interpreting the FITS files follow the table.</p>'
	...
	;;; Labels for mosaic_YYYY.html
        ...
        html_index = '<div style="width:840px; height:45px; padding:1px 1px 1px 15px; border:0px solid blue; line-height:30px; display:table-cell"><center>Index by year</center></div>'
        if year4web ge 2013 then begin
		html_allin1 = '<div style="width:840px; height:45px; padding:1px 1px 1px 10px; border:0px solid blue; float:left; line-height:33px; display:table-cell"><center><a href="mosaic_test_all.html">All Mosaics in 1 page</a></center></div>'
		html_previous = '<div style="width:150px; height:45px; padding:1px 25px 1px 1px; border:0px solid blue; float:left; line-height:33px; display:table-cell"><center><a href="mosaic_'+year4web_prev+'.html"><< Previous</a></center></div>'
		if year4web eq 2013 then $& 
			html_previous = '<div style="width:150px; height:45px; padding:1px 25px 1px 1px; border:0px solid blue; float:left; line-height:33px; display:table-cell"><center>           </center></div>'
		html_year = '<div style="width:505px; height:45px; padding:1px 50px 1px 1px; border:0px solid blue; float:left; line-height:33px; display:table-cell"><center>'+year4web_txt+'</center></div>'
		...
		html_next = '<div style="width:81px; height:45px; padding:1px 25px 1px 1px; border:0px solid blue; float:left; line-height:33px; display:table-cell"><right><a href="mosaic_'+year4web_next+'.html">Next >></a></center></div>'
	endif
	;;; Labels for mosaic_YYYY.html
	html_rowend = '</div>'
	...
	htmlfile = CONCAT_DIR('/sanhome1/asainz/IRIS_mosaic', 'mosaic_test_all.html')
	template_year= CONCAT_DIR('/sanhome1/asainz/IRIS_mosaic', 'template_mosaic_year.html')
	template_index = CAT_DIR('/sanhome1/asainz/IRIS_mosaic', 'template_index.html')
